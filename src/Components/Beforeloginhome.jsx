...
import "../Css/Beforeloginhome.css";
      ...
      <div className="mainconbelog">
        <div className="protectorfirstlog">
          <div className="firstbeforelog">
            ...
            <p className="unnecessary1">Sign in to like videos,</p>
            <p className="unnecessary1">comment, and subscribe.</p>

            <div className="thirdnavcon1" onClick={handleSignIn}>
