...
import Loading from "../Allsimilar/Loading.jsx";
...
const Searchvideo = () => {
  ...
  function handleclickData(event) {
    clickData2(event.target.innerText);
  }
      ...
      <div className="mainconbelog">
        <div className="protectorfirstlog">
          <div className="firstbeforelog">
            <div className="icondiv1" onClick={gobacktohome}>
              <svg
        ...
        <div className="secondbeforelog">
          <div className="fixedmake">
            <div className="topics">
              ...
              <div onClick={handleclickData}>T-Series</div>
              <div onClick={handleclickData}>Baalveer</div>
              <div onClick={handleclickData}>Movie musicals</div>
              <div onClick={handleclickData}>Superhero movies</div>
              <div onClick={handleclickData}>Thrillers</div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="textrelatedcon">
                      ...
                      <p id="chennelname">{ele.snippet.channelTitle}</p>
                    </div>
                  </div>
                );
              })}
